            ...
            try {
                ...
                try {
                    ...
                    LOG.info("ExecutionTime for Container: " + request.getContainerIdString() + "=" +
                            runtimeWatch.stop().elapsed().toMillis());
                    if (LOG.isDebugEnabled()) {
                        LOG.debug(
                ...
                synchronized (this) {
                    ...
                    if (taskRunner != null) {
                        ...
                        if (killed) {
                            ...
                            completionListener.fragmentCompleting(getRequestId(),
                                    SchedulerFragmentCompletingListener.State.KILLED);
                            reportTaskKilled();
                        } else {
            ...
            switch (result.getEndReason()) {
                ...
                case KILL_REQUESTED:
                    ...
                    if (killtimerWatch.isRunning()) {
                        killtimerWatch.stop();
                        long elapsed = killtimerWatch.elapsed().toMillis();
                    ...
                    if (metrics != null) {
                        metrics.addMetricsPreemptionTimeLost(runtimeWatch.elapsed().toMillis());
                        metrics.incrExecutorTotalKilled();
                    }
                    break;
